      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col gap-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl shadow-2xl transition-all duration-300 flex items-start w-full overflow-hidden hover:scale-105"
            >
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-black mb-8 mt-4 leading-tight tracking-tight">{step.title}</h2>
