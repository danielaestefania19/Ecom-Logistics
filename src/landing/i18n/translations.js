export const translations = {
  en: {
    ...
    heroDesc1:
      "for Ecommerce Sellers: 3rd party logistics (3PL), Amazon fba Prep Center,",
    heroDesc2:
      " Amazon Freight Partner (LTL & FTL). All you need in one place!",
    // Contact Us
    contactTitle: "Contact Us",
    contactSubtitle:
      "We would like to hear from you! Fill out your contact information below.",
    formFirstName: "First name",
    formLastName: "Last name",
    formCompany: "Company name",
    formCompanyWebsite: "Company website",
    formEmail: "Email address",
    formPhone: "Phone number",
    formLanguage: "Select a language for the service",
    formServiceType: "Type of service",
    formUnits: "Number of units",
    formShipments: "Shipments per month",
    formMessage: "Any additional information...",
    formSubmit: "Submit",
    formSending: "Sending your message...",
    formSuccess: "Information sent successfully. We will contact you shortly.",
    formError: "Something went wrong. Please try again later.",
    formState: "State",
    formCity: "City",
    formSelectState: "Select a state",
    formSelectCity: "Select a city",
    formSelectStateFirst: "Select a state first",
    formHeardFrom: "Where did you hear about us?",
    errorHeardFromRequired: "This field is required",
    ...
    errorCompanyWebsiteRequired: "Company website is required",
    errorEmailRequired: "Email is required",
    errorInvalidEmail: "Invalid email format",
    errorPhoneRequired: "Phone is required",
    errorLanguageRequired: "Language is required",
    errorServiceTypeRequired: "Service type is required",
    errorUnitsRequired: "Number of units is required",
    errorShipmentsRequired: "Shipments per month are required",
    errorMessageRequired: "Message is required",
    errorStateRequired: "State is required",
    errorCityRequired: "City is required",
    errorPhoneInvalid: "Phone must contain only numbers",
    errorUnitsInvalid: "Units must be a valid number",
    ...
    fbaDesc:
      "Amazon Prep Center specialized in preparing, labeling, bundling, and shipping inventory to Amazon warehouses, ensuring full compliance with FBA standards.",
    tiktokTitle: "3PL (Shopify, Amazon, Tiktok Shop)",
    tiktokDesc:
      " Efficient inventory management, secure storage, and state-of-the-art picking and packing processes in our 3PL warehouse.",
    storageTitle: "Storage Service",
    storageDesc:
      "Looking for secure storage for your products? Our warehouse has the space you need to keep your inventory safe and organized. Try us out! All customers get First 7 days of free storage.",
    ...
    //CoverageMap
    coverageHeadline: "Did you know?",
    coverageFactPrefix: "Over",
    coverageFactHighlight1: "40% of U.S. imports",
    coverageFactMiddle: "come through",
    coverageFactHighlight2: "California",
    coverageFactSuffix:
      "home to the biggest brands and suppliers. That’s not just trivia,",
    coverageFactHighlight3: "it’s your business advantage!",
    coverageWelcomePrefix: "Welcome to",
    coverageWelcomeHighlight: "California",
    coverageWelcomeSuffix: "the core of American logistics.",
    coverageCenterPrefix: "Right at the center is",
    coverageCenterHighlight: "Ecom Logistics",
    coverageBayAreaPrefix: "Based in the",
    coverageBayAreaHighlight: "Bay Area",
    coverageBayAreaSuffix:
      "we’re exactly where commerce moves fastest, closer to the ports, closer to suppliers, closer to success.",
    ...
    //Discount
    discountHeadline1: "Are you overpaying for",
    discountHeadline2: "LTL Services and losing time?",
    ...
    //WhyEcom
    whyEcomTitle: "Why Ecom",
    whyEcomCard1Title: "#1 LTL & Prep Rates",
    whyEcomCard1Text:
      "Save more with the leading LTL and Prep Rates in Northern California. Increase your margins with Ecom Logistics' exceptional pricing. Our LTL and prep rates are the most competitive in the region, tailored for e-commerce sellers. Save on every shipment without sacrificing quality.",
    whyEcomCard2Title: "Expert Support & Advisors",
    whyEcomCard2Text:
      "At Ecom Logistics, we have 5 years of experience in the logistics industry. Our trained team is here to offer you advice and support at every stage, from the initial pricing inquiry to the completion of your order.",
    whyEcomCard3Title: "Efficiency Guaranteed",
    whyEcomCard3Text:
      "We are committed to delivering fast and efficient service every time. With a highly trained team, we guarantee that your shipments are handled swiftly, meeting deadlines and ensuring quality.",
    //Logistics
    logisticsTitle: "Get in touch today!",
    logisticsSubtitleLine1: "Our team will respond to your inquiry in",
    logisticsSubtitleLine2: "less than 24 hours.",
    logisticsDescription: "Your E-Commerce Logistics Partner",
    logisticsButton: "Contact Us!",
    //Footer
    ...
    advantages: {
      ...
      timeValue: "24 - 72 Hrs",
      timeLabel: "for delivery to Amazon FCs once it leaves our warehouse.",
      accuracyValue: "98%",
      accuracyLabel: "On-Time LTL & FTL Delivery Accuracy",
      pickupValue: "Free Daily Pickup",
      pickupLabel: "In the Bay Area",
    },
    //Pricing
    pricingAmazon: {
      title: "Top Rated LTL Prices",
      subtitle: "in Northern California",
      button: "Check Pricing",
    },
    //Request
    request: {
      title: "Steps to Request an LTL or FTL Service",
      step1: {
        title: "STEP 1",
        description:
          "Contact us to receive a free quote and open your account.",
      },
      step2: {
        title: "STEP 2",
        description:
          "Work with our team to get your LTL or FTL shipment prepared and your pallets ready.",
      },
      step3: {
        title: "STEP 3",
        description:
          "Finalize the payment process with assistance from our support team.",
      },
      step4: {
        title: "STEP 4",
        description:
          "We’ll coordinate a free pickup or local delivery within the San Francisco Bay Area.",
      },
      step5: {
        title: "STEP 5",
        description:
          "Your products will be delivered to the Amazon fulfillment center within 2 to 3 days from the date of shipment.",
      },
    },
    //CoverageMap
    coverageMap: {
      ...
      intro: [
        {
          ...
          description:
            "We are trusted by top Amazon sellers for reliability and efficiency.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Premium logistics at prices that work for your business.",
        },
      ],
      table: {
        feature: "Features",
        others: "Others (AAA Cooper)",
      },
      featureLabels: {
        "Delivery Time": "Delivery Time",
        Liftgate: "Liftgate",
        "Residential Pickup": "Residential Pickup",
        "Commercial Pickup": "Commercial Pickup",
        "Hazmat Handling": "Hazmat Handling",
        "POD at Amazon FC": "POD at Amazon FC",
        "Daily Pickup": "Daily Pickup",
        "Personalized Support": "Personalized Support",
        "Exclusive Monthly Offers and Discounts":
          "Exclusive Monthly Offers and Discounts",
      },
      features: [
    ...
    localMoving: {
      title: "Local Moving",
      description1: {
        pre: " Whether you're picking up goods from your supplier or handling local deliveries in California (LTL or SPD),",
        post: " has you covered. Our extensive fleet, combined with trusted logistics partners, ensures seamless operations with flexible, reliable service tailored to your needs.",
      },
      description2: "Contact us today for a customized quote!",
      button: "Contact Us",
    },
    //FAQ
    faq: {
      ...
      questions: [
        {
          question:
            "What are the benefits of choosing Ecom Logistics for shipping to Amazon fulfillment centers?",
          answer:
            "We specialize in Amazon FBA compliance, fast delivery windows, and smooth coordination with FCs.",
        },
        {
          question:
            "How fast can Ecom Logistics deliver my Amazon LTL products to an Amazon FBA warehouse?",
          answer:
            "After the pallet pickup, it may take 1 to 3 days for them to leave our warehouses. Once they leave our facility, it takes 1 to 3 days for delivery to the Amazon fulfillment centers (FC). (Please note that unexpected events beyond our control may cause delays in the process). However, we are fully prepared to handle these situations and resolve them as quickly as possible.",
        },
        {
          question:
            "Does Ecom Logistics offer free pickup service for LTL freight?",
          answer:
            "Yes, standard pickup is included in most service plans—contact us to confirm based on your area.",
        },
        {
          question:
            " Can Ecom Logistics provide liftgate service if a forklift is unavailable at pickup or delivery?",
          answer:
            "Absolutely. We offer liftgate-equipped trucks for safe and easy loading/unloading.",
        },
        {
          question:
            "How can I track my shipment to Amazon FC with Ecom Logistics?",
          answer:
    ...
    prepHeader: {
      title: "Amazon FBA",
      highlight: "Prep Center",
      description1:
        "At Ecom Logistics, we don’t just prepare your products, we optimize your entire FBA process.",
      description2:
        "With great prices, fast service, and reliable support, we help you save time, cut costs, and grow your business.",
      description3: "We’re more than a prep center, We’re your best move.",
    ...
    prepAdvantages: {
      ...
      timeValue: "24 - 48 Hrs",
      timeLabel: "To get ready your products.",
      qcValue: "100%",
      qcLabel: "Quality Control.",
      deliveryValue: "99.9%",
      deliveryLabel: "on-time delivery (Daily outbound shipments).",
    },
    //Pricing
    prepPricing: {
      title: "Ecom Logistics combines speed, trust, and",
    ...
    storage: {
      ...
      subtitle: "Get the First Week On Us – Fast, Reliable Warehousing",
      description:
        "Take advantage of our introductory offer and enjoy peace of mind with secure storage.",
      button: "Get our storage prices",
    },
    //FAQ
    prepCenter: {
      ...
      faqItems: [
        {
          question:
            "How long does it take Ecom Logistics to prepare my products for Amazon FBA?",
          answer:
            "Most orders are prepped within 24–48 hours, depending on volume and requirements.",
        },
        {
          question:
            " Can Ecom Logistics receive shipments directly from my suppliers?",
          answer:
            "Yes, we receive, inspect, and process shipments directly from your vendors.",
        },
        {
          question:
            " Does Ecom Logistics have experience handling Hazmat or oversized items?",
          answer:
            "Yes, we’re trained and equipped to manage Hazmat and large-size product categories.",
        },
        {
          question:
            "Are my products securely stored at Ecom Logistics facilities?",
          answer:
            "Absolutely. Our warehouses are monitored 24/7 and follow strict safety protocols.",
        },
        {
    ...
    //Advantage
    tiktokShopAdvantages: {
      title: "The Best Pick, Pack & Ship For E-Commerce",
      metric1: {
        value: "24/7",
        description:
          "Full, real-time visibility and control of your stock from anywhere.",
      },
      metric2: {
        value: "99%",
        description:
          "Orders processed and shipped quickly with maximum accuracy.",
      },
      metric3: {
        value: "100%",
        description: "Personalized support from our team of professionals.",
      },
    },
    //Pricing
    tiktokShopPricing: {
      title: "Ecom Logistics offers reliable",
      subtitle: "service and unbeatable pricing.",
      cta: "Check Pricing",
    },
    //Request
    tiktokShopRequest: {
      title: "Our Logistics Process",
      step1Title: "Receive & Inspect Merchandise",
      step1Description:
      ...
      step2Title: "Store Your Goods Safely",
      step2Description:
      ...
      step3Title: "Pick, Pack & Ship Your Products",
      step3Description:
    ...
    tiktokShopPackaging: {
      title: "Don’t Forget! All Packaging Materials Are Included 📦",
      description:
    ...
    tiktokShopStorage: {
      ...
      description:
        "Take advantage of our introductory offer and enjoy peace of mind with secure storage.",
      cta: "Get our storage prices",
    },
    //ContactUs
    tiktokShopContact: {
      title: "Contact Us",
      subtitle:
        "Ready to optimize your logistics? Get a logistics quote in less than 24 hours.",
      placeholders: {
      ...
      success:
        "Information sent successfully. We will contact you within a few minutes.",
      error:
        "Something went wrong while sending your information. Please try again later.",
      errors: {
    ...
    AboutUs: {
      ...
      storyIntro:
        "We’ve lived the e-commerce journey ourselves, so we truly understand what sellers need to grow. Our experience has shaped every part of our service, from fast response times to flexible solutions, because we know what it’s like to be on the other side.",
      storyParagraph1: {
        pre: "We started with a simple belief: ",
        highlight: "logistics shouldn’t hold growing companies back.",
        post: " As entrepreneurs, we knew how complex logistics could be for small businesses trying to scale.",
      },
      storyParagraph2: {
        pre: "That’s why we created ",
        highlight: "Ecom Logistics",
        post: ", to simplify and optimize the logistics process for e-commerce sellers of all sizes.",
      },
    },
    //WhooWeAre
    whoWeAre: {
      ...
      highlights: {
        ltl: "LTL pallet shipping",
        fulfillment: "3PL fulfillment",
        fba: "Amazon FBA prep",
        local: "local moving solutions",
      },
      conclusion:
        ". Whether you’re a growing brand or a high-volume seller, our team is here to make your logistics easier, faster, and more efficient.",
    },
    //WhatWeOffer
    whatWeOffer: {
      title: "What We Offer",
      intro:
        "At Ecom Logistics, we simplify your logistics so you can focus on growing your business. With tailored solutions and years of experience, we offer the services that keep your e-commerce operations running efficiently and securely.",
      services: [
        {
    ...
    //SuccessSection
    successSection: {
      title: "Let’s Achieve Success Together",
      paragraph1:
        "At Ecom Logistics, we believe in the power of partnership. We’re not just here to handle your logistics – we’re here to help you grow, scale, and succeed. With our expertise and dedication, we’ll work closely with you every step of the way to streamline your operations and reach your business goals.",
      highlight: "Are you ready to unlock your business's full potential?",
      call: "Contact us now, and together we’ll build a logistics solution that propels your growth and delivers real results.",
    },
    //ContacUs
    contactAboutUs: {
      title: "Contact Us",
  ...
  es: {
    ...
    heroDesc1:
      "Para Vendedores de E-commerce: logística de terceros (3PL), Centro de Preparación Amazon FBA,",
    heroDesc2:
      "Socio de Carga de Amazon (LTL y FTL). ¡Todo lo que necesitas en un solo lugar!,",
    // Contact Us
    contactTitle: "Contáctanos",
    contactSubtitle:
      "¡Nos encantaría saber de ti! Llena tus datos de contacto y te responderemos pronto.",
    formFirstName: "Nombre",
    formLastName: "Apellido",
    formCompany: "Nombre de la empresa",
    formCompanyWebsite: "Sitio web de la empresa",
    formEmail: "Correo electrónico",
    formPhone: "Teléfono",
    formLanguage: "Seleccione un idioma para el servicio",
    formServiceType: "Tipo de servicio",
    formUnits: "Unidades por mes",
    formShipments: "Envíos por mes",
    formMessage: "Información adicional...",
    formSubmit: "Enviar",
    formSending: "Enviando tu mensaje...",
    formSuccess: "Información enviada con éxito. Te contactaremos pronto.",
    formError: "Ocurrió un error. Por favor, intenta de nuevo más tarde.",
    formState: "Estado",
    formCity: "Ciudad",
    formSelectState: "Selecciona un estado",
    formSelectCity: "Selecciona una ciudad",
    formSelectStateFirst: "Primero selecciona un estado",
    formHeardFrom: "¿Dónde escuchaste de nosotros?",
    errorHeardFromRequired: "Este campo es obligatorio",


    // Mensajes de error
    errorFirstNameRequired: "El nombre es obligatorio",
    errorLastNameRequired: "El apellido es obligatorio",
    errorCompanyNameRequired: "El nombre de la empresa es obligatorio",
    errorCompanyWebsiteRequired: "El sitio web de la empresa es obligatorio",
    ...
    errorLanguageRequired: "El idioma es obligatorio",
    errorServiceTypeRequired: "El tipo de servicio es obligatorio",
    errorUnitsRequired: "Las unidades por mes son obligatorias",
    errorShipmentsRequired: "Los envíos por mes son obligatorios",
    ...
    errorPhoneInvalid: "El teléfono debe contener solo números",
    ...
    servicesDesc:
      "En Ecom Logistics, ofrecemos un espectro completo de soluciones integradas diseñadas para optimizar sus operaciones e impulsar el crecimiento. Descubra cómo nuestros servicios expertos de 3PL, preparación de FBA y envío de carga pueden beneficiar a su negocio.",
    servicesAll: "Todos los Servicios",
    ltlTitle: " Envíos LTL y FTL de Amazon",
    ltlDesc:
      " Ecom Logistics proporciona opciones fiables de envío de Carga Parcial (LTL) y Carga Completa (FTL) para satisfacer todas sus necesidades de carga comercial. Como Socio de Carga de Amazon experimentado, garantizamos una entrega fluida y eficiente a los centros de fulfillment de Amazon. Optimice su cadena de suministro con nuestros servicios de transporte rentables.",
    fbaTitle: "Centro de Preparación FBA",
    fbaDesc:
      " Centro de preparación de Amazon especializado en preparar, etiquetar, empaquetar y enviar inventario a los almacenes de Amazon, asegurando el cumplimiento total de los estándares de FBA.",
    tiktokTitle: "3PL (Shopify, Amazon, Tiktok Shop)",
    tiktokDesc:
      " Gestión eficiente de inventario, almacenamiento seguro y procesos de picking y packing de última generación en nuestro almacén 3PL.",
    storageTitle: "Servicio de Almacenamiento",
    storageDesc:
      "Ofrecemos almacenamiento seguro, organizado y con 7 días gratuitos para todos los clientes nuevos.",
    localTitle: "Mudanzas Locales",
    localDesc:
      "Nos encargamos de tus entregas o recogidas locales en California. LTL o SPD, sin estrés.",
    brandTitle: "Gestión de Marcas",
    brandDesc:
      "Estrategias de marca completas: descubrimiento, identidad visual y monitoreo de rendimiento para posicionarte en el mercado.",
    learnMore: "Ver más",
    ...
    coverageFactHighlight2: "California",
    coverageFactSuffix:
      "hogar de las marcas y proveedores más grandes. No es solo un dato,",
    coverageFactHighlight3: "¡es tu ventaja competitiva!",
    coverageWelcomePrefix: "Bienvenido a",
    coverageWelcomeHighlight: "California",
    coverageWelcomeSuffix: "el núcleo de la logística en EE.UU.",
    coverageCenterPrefix: "En el centro está",
    coverageCenterHighlight: "Ecom Logistics",
    coverageBayAreaPrefix: "Con sede en el",
    coverageBayAreaHighlight: "Área de la Bahía",
    coverageBayAreaSuffix:
      "estamos donde el comercio se mueve más rápido, cerca de los puertos, de los proveedores y del éxito.",
    ...
    //FulfillmentPromise
    fulfillmentHeadline:
      "Centro de Fulfillment Mejor Valorado en la Costa Oeste",
    ...
    whyEcomCard1Text:
      "Ahorra más con las tarifas LTL y de preparación líderes en el norte de California. Aumenta tus márgenes con los precios excepcionales de Ecom Logistics. Nuestras tarifas están diseñadas para vendedores de e-commerce. Ahorra en cada envío sin sacrificar calidad.",
    whyEcomCard2Title: "Soporte Experto y Asesores",
    whyEcomCard2Text:
      "En Ecom Logistics, tenemos 5 años de experiencia en la industria logística. Nuestro equipo capacitado está listo para apoyarte en cada etapa, desde la cotización inicial hasta la entrega final.",
    whyEcomCard3Title: "Eficiencia Garantizada",
    whyEcomCard3Text:
      "Estamos comprometidos a brindar un servicio rápido y eficiente siempre. Con un equipo altamente capacitado, garantizamos que tus envíos se manejen sin demoras, cumpliendo plazos y con calidad.",
    //Logistics
    logisticsTitle: "¡Contáctanos hoy!",
    logisticsSubtitleLine1: "Nuestro equipo responderá a tu consulta en",
    logisticsSubtitleLine2: "menos de 24 horas.",
    logisticsDescription: "Tu socio logístico para E-Commerce",
    logisticsButton: "¡Contáctanos!",
    //Footer
    ...
    amazonHeader: {
      ...
      description2:
        "Además, ofrecemos algunas de las mejores tarifas y tiempos de entrega más rápidos de la región.",
      cta: "Contactar Ventas",
    },
    //Advantages
    advantages: {
      headline:
        "¡Deja de perder tiempo y evita cargos extra con nuestro servicio confiable de carga!",
      timeValue: "24 - 72 Hrs",
      timeLabel:
        "de entrega a centros de Amazon una vez sale de nuestro almacén.",
      accuracyValue: "98%",
      accuracyLabel: "Precisión en entregas LTL & FTL a tiempo",
      pickupValue: "Recogida Diaria Gratuita",
      pickupLabel: "En el Área de la Bahía",
    },
    //Pricing
    pricingAmazon: {
      title: "Los mejores precios (LTL) ",
      subtitle: "en el Norte de California",
      button: "Ver Precios",
    },
    //Request
    request: {
      title: "Pasos para solicitar un servicio LTL o FTL",
      step1: {
        title: "PASO 1",
        description:
          "Contáctanos para recibir una cotización gratuita y abrir tu cuenta.",
      },
      step2: {
        title: "PASO 2",
        description:
          "Trabaja con nuestro equipo para preparar tu envío LTL o FTL y alistar tus paletas.",
      },
      step3: {
        title: "PASO 3",
        description:
          "Finaliza el proceso de pago con ayuda de nuestro equipo de soporte.",
      },
      step4: {
        title: "PASO 4",
        description:
          "Coordinamos una recojida gratuita o entrega local dentro del Área de la Bahía de San Francisco.",
      },
      step5: {
        title: "PASO 5",
        description:
          "Tus productos serán entregados al centro logístico de Amazon en un plazo de 2 a 3 días desde el envío.",
      },
    },
    //CoverageMap
    coverageMap: {
      ...
      desc1: {
        ...
        comma:
          ", nos especializamos en proporcionar soluciones rápidas y puntuales de envío ",
        service1: "Amazon LTL",
        and2: " y ",
        service2: "FTL",
        region: " en toda la ",
        ...
        final:
          " de forma rápida, rentable y con total cumplimiento de las normas FBA 📦✅.",
      },
      desc2: {
        pre: "¡",
    ...
    //WhyChooseUs
    whyChooseUs: {
      title: "¿Por qué elegir Ecom Logistics?",
      intro: [
        {
          title: "Servicio de Alta Calificación",
          description:
            "Somos confiables para los principales vendedores de Amazon por nuestra eficiencia.",
        },
        {
          title: "Soporte al Cliente 24/7",
          description:
            "Siempre disponibles para ayudarte con atención personalizada.",
        },
        {
          title: "Precios Competitivos",
          description:
            "Logística premium a precios que se adaptan a tu negocio.",
        },
      ],
      table: {
        feature: "Características",
        others: "Otros (AAA Cooper)",
      },
      featureLabels: {
        ...
        "Exclusive Monthly Offers and Discounts":
          "Ofertas y Descuentos Mensuales Exclusivos",
      },
      features: [
        ["Delivery Time", "3 – 7 días", "1 – 2 semanas", "2 – 3 semanas"],
        ["Liftgate", true, false, true],
        ["Residential Pickup", true, false, false],
        ["Commercial Pickup", true, true, true],
        ["Hazmat Handling", true, false, false],
    ...
    faq: {
      ...
      subtitle:
        "Todo lo que necesitas saber sobre cómo gestionamos, almacenamos y enviamos tus productos.",
      button: "Comenzar",
      questions: [
        {
          question:
            " ¿Cuáles son los beneficios de elegir Ecom Logistics para el envío de carga (Amazon freight) a los centros de fulfillment de Amazon?",
          answer:
            "Nos especializamos en el cumplimiento de Amazon FBA, entregas rápidas y una coordinación fluida con los centros de cumplimiento (FC).",
        },
        {
          question:
            "¿Qué tan rápido puede Ecom Logistics entregar mis productos LTL de Amazon a un almacén de Amazon FBA?",
          answer:
            "Después del recojo de la paleta, puede tomar de 1 a 3 días para que los productos salgan de nuestros almacenes. Una vez fuera, la entrega al centro de cumplimiento toma entre 1 y 3 días. (Ten en cuenta que eventos imprevistos pueden ocasionar retrasos, pero estamos preparados para manejarlos de forma eficiente).",
        },
        {
          question:
            "¿Ecom Logistics ofrece servicio de recogida gratuito para carga LTL?",
          answer:
            "Sí, el recojo estándar está incluido en la mayoría de los planes de servicio. Contáctanos para confirmar según tu ubicación.",
        },
        {
          question:
            "¿Puede Ecom Logistics proporcionar servicio de puerta elevadora si no hay un montacargas disponible en la recogida o entrega?",
          answer:
            "Por supuesto. Contamos con camiones equipados con montacargas para una carga y descarga seguras.",
        },
        {
          question:
            "¿Cómo puedo rastrear mi envío de carga (Amazon freight) a Amazon FC con Ecom Logistics?",
          answer:
    ...
    prepHeader: {
      title: "Amazon FBA",
      highlight: "Centro de Preparación",
      description1:
        "En Ecom Logistics no solo preparamos tus productos, optimizamos todo tu proceso FBA.",
      description2:
        "Con precios competitivos, servicio rápido y soporte confiable, te ayudamos a ahorrar tiempo, reducir costos y hacer crecer tu negocio.",
      description3:
        "Somos más que un centro de preparación, somos tu mejor movimiento.",
      button: "Contactar Ventas",
    },
    //Advantages
    prepAdvantages: {
      title:
        "Entrega de preparación FBA de alta calidad con velocidad, precisión y confiabilidad.",
      timeValue: "24 - 48 Hrs",
      timeLabel: "Para tener tus productos listos.",
      qcValue: "100%",
      qcLabel: "Control de calidad.",
      deliveryValue: "99.9%",
      deliveryLabel: "entregas a tiempo (envíos diarios).",
    },
    //Pricing
    prepPricing: {
    ...
    //Request
    logistics: {
      title: "Nuestro Proceso Logístico",
      subtitle:
        "En Ecom Logistics no solo ofrecemos servicios logísticos — nos convertimos en tu socio estratégico para crecer.",
      footer:
        "¿Listo para ver la diferencia? ¡Contáctanos hoy y déjanos mostrarte cómo podemos llevar tu logística al siguiente nivel!",
      steps: {
        receiving: {
          title: "Recepción de Inventario",
          description:
            "Recibimos envíos de tus proveedores, asegurando una transición fluida del fabricante al centro de cumplimiento.",
        },
        inspection: {
          title: "Inspección del Producto",
          description:
            "Cada artículo se inspecciona para verificar calidad y cantidad, cumpliendo con los estándares de Amazon.",
        },
        prep: {
          title: "Preparación, Etiquetado y Empaque",
          description:
            "Aplicamos etiquetas FNSKU y empacamos tus productos de forma segura con bolsas, burbujas y kits.",
        },
        storage: {
          title: "Almacenamiento",
          description:
            "Ofrecemos almacenamiento temporal, manteniendo tu inventario organizado y listo para envío. ¡7 días gratis!",
        },
        shipping: {
          title: "Envío a Amazon FBA",
          description:
            "Gestionamos tus envíos a centros de cumplimiento Amazon, con entrega puntual y proceso SPD o LTL completo.",
        },
        compliance: {
          title: "Documentación de Cumplimiento",
          description:
            "Nos encargamos de toda la documentación necesaria para cumplir con los requisitos de Amazon FBA y normas internacionales.",
        },
      },
    },
    //FreeStorageOffer
    storage: {
      title: "¡7 Días de Almacenamiento Gratis!",
      subtitle:
        "La primera semana va por nuestra cuenta – Almacenamiento rápido y confiable",
      description:
        "Aprovecha nuestra oferta de introducción y disfruta de la tranquilidad con almacenamiento seguro.",
      button: "Consulta nuestros precios de almacenamiento",
    },
    //FAQ
    prepCenter: {
      ...
      faqItems: [
        {
          question:
            "¿Cuánto tiempo tarda Ecom Logistics en preparar mis productos para Amazon FBA?",
          answer:
            "La mayoría de los pedidos se preparan en 24–48 horas, dependiendo del volumen y los requisitos.",
        },
        {
          question:
            "¿Ecom Logistics puede recibir envíos directamente de mis proveedores?",
          answer:
            "Sí, recibimos, inspeccionamos y procesamos envíos directamente de tus proveedores.",
        },
        {
          question:
            "¿Ecom Logistics tiene experiencia con productos peligrosos o de gran tamaño?",
          answer:
            "Sí, estamos capacitados y equipados para manejar productos Hazmat y de gran tamaño.",
        },
        {
          question:
            "¿Mis productos están seguros en las instalaciones de Ecom Logistics?",
          answer:
            "Por supuesto. Nuestros almacenes están monitoreados 24/7 y siguen estrictos protocolos de seguridad.",
        },
        {
          question: "¿Qué métodos de pago acepta Ecom Logistics?",
          answer:
    ...
    tiktokShop: {
      header: {
        ...
        description:
          "Brindamos soluciones logísticas 3PL confiables y completamente personalizadas con precios competitivos. Escala tu negocio con envíos más rápidos, menores costos y mayor eficiencia.",
        cta: "Contactar ventas",
      },
    },
    //Advantage
    tiktokShopAdvantages: {
      title: "El mejor servicio de Pick, Pack & Ship para e-commerce",
      metric1: {
        value: "24/7",
        description:
          "Visibilidad y control en tiempo real de tu inventario desde cualquier lugar.",
      },
      metric2: {
        value: "99%",
        description:
          "Pedidos procesados y enviados rápidamente con máxima precisión.",
      },
      metric3: {
        value: "100%",
        description: "Atención personalizada de nuestro equipo profesional.",
      },
    },
    //Pricing
    tiktokShopPricing: {
      title: "Ecom Logistics ofrece un servicio confiable",
      subtitle: "y precios inigualables.",
      cta: "Ver precios",
    },
    //Request
    tiktokShopRequest: {
      title: "Nuestro proceso logístico",
      step1Title: "Recibir e inspeccionar mercancía",
      step1Description:
        "Recibimos tus productos e inspeccionamos cuidadosamente que cumplan con todos los estándares de calidad antes de almacenarlos.",
      step2Title: "Almacena tus productos de forma segura",
      step2Description:
        "Tus productos se almacenan en condiciones óptimas, con monitoreo 24/7 para garantizar su integridad hasta el momento del envío.",
      step3Title: "Preparar y enviar tus productos",
      step3Description:
        "Seleccionamos, empacamos y enviamos tus productos con rapidez y precisión para que lleguen a tus clientes sin errores.",
    },
    //FreePackagingSection
    tiktokShopPackaging: {
      title:
        "¡No lo olvides! Todos los materiales de embalaje están incluidos 📦",
      description:
        "No tienes que preocuparte por cargos extra. Todo está incluido en nuestro precio. Tus cajas, cintas, etiquetas y materiales ya vienen integrados para que te enfoques en hacer crecer tu negocio mientras nosotros nos encargamos del resto.",
    },
    //FreeStorageOffer
    tiktokShopStorage: {
      title: "¡7 días de almacenamiento gratis!",
      subtitle:
        "Obtén la primera semana sin costo – Almacenaje rápido y confiable",
      description:
        "Aprovecha nuestra oferta de bienvenida y disfruta de tranquilidad con almacenamiento seguro.",
      cta: "Consulta nuestros precios de almacenamiento",
    },
    //ContactUs
    tiktokShopContact: {
      title: "Contáctanos",
      subtitle:
        "¿Listo para optimizar tu logística? Obtén una cotización en menos de 24 horas.",
      placeholders: {
        firstName: "Nombre",
        lastName: "Apellido",
      ...
      success:
        "Información enviada exitosamente. Te contactaremos en unos minutos.",
      error:
        "Ocurrió un error al enviar la información. Por favor intenta más tarde.",
      errors: {
    ...
    faqTiktok: {
      ...
      questions: [
        {
          question:
            "¿Existe un volumen mínimo mensual de envíos para asociarse con Ecom Logistics?",
          answer:
            "No, ofrecemos planes flexibles para apoyar a empresas de todos los tamaños sin requerir un volumen mensual fijo.",
        },
        {
          question:
            "¿Quién mantiene la propiedad de los productos mientras están almacenados y manejados por Ecom Logistics?",
          answer:
            "Tú conservas la propiedad total de tu inventario en todo momento; nosotros solo lo almacenamos y gestionamos por ti.",
        },
        {
          question:
            "¿Cómo determina Ecom Logistics los precios para los servicios 3PL?",
          answer:
            "Los precios se basan en el volumen, las necesidades de almacenamiento y la complejidad del servicio. Adaptamos los presupuestos a tu negocio.",
        },
        {
          question:
            "¿Cómo gestiona Ecom Logistics el proceso de cumplimiento de pedidos?",
          answer:
            "Recibimos, seleccionamos, empacamos y enviamos tus pedidos con seguimiento en tiempo real y visibilidad del inventario.",
        },
        {
          question:
    ...
    AboutUs: {
      ...
      storyIntro:
        "Hemos recorrido el camino del comercio electrónico, por eso entendemos realmente lo que los vendedores necesitan para crecer. Nuestra experiencia ha moldeado cada parte del servicio: desde tiempos de respuesta rápidos hasta soluciones flexibles, porque sabemos lo que es estar del otro lado.",
      storyParagraph1: {
        pre: "Comenzamos con una creencia simple: ",
        highlight:
          "la logística no debería frenar a las empresas en crecimiento.",
        post: " Como emprendedores, sabíamos lo complejo que podía ser el proceso logístico para los pequeños negocios que intentan escalar.",
      },
      storyParagraph2: {
        pre: "Por eso creamos ",
        highlight: "Ecom Logistics",
        post: ", para simplificar y optimizar el proceso logístico para vendedores de e-commerce de todos los tamaños.",
      },
    },
    //WhoWeAre
    whoWeAre: {
      title: "Quiénes Somos",
      paragraph1:
        "En Ecom Logistics, ofrecemos soluciones logísticas inteligentes y escalables diseñadas para el dinámico mundo del comercio electrónico. Con sede en el Área de la Bahía, California, operamos desde uno de los centros logísticos más estratégicos del país, justo al lado de los puertos y proveedores que mantienen en movimiento a Estados Unidos.",
      paragraph2:
        "Nos especializamos en servicios clave que respaldan toda la cadena de suministro de e-commerce, incluyendo el ",
      highlights: {
        ltl: "envío de palets LTL",
        fulfillment: "cumplimiento 3PL",
        fba: "preparación para Amazon FBA",
        local: "soluciones locales de mudanza",
      },
      conclusion:
        ". Ya seas una marca en crecimiento o un vendedor de alto volumen, nuestro equipo está aquí para hacer tu logística más fácil, rápida y eficiente.",
    },
    //WhatWeOffer
    whatWeOffer: {
      title: "Lo Que Ofrecemos",
      intro:
        "En Ecom Logistics, simplificamos tu logística para que puedas concentrarte en hacer crecer tu negocio. Con soluciones personalizadas y años de experiencia, ofrecemos los servicios que mantienen tus operaciones de e-commerce eficientes y seguras.",
      services: [
        {
          title: "Envíos LTL a Amazon",
          description:
            "Rápidos, confiables y económicos, asegurando que tus productos lleguen a los centros de cumplimiento de Amazon a tiempo.",
        },
        {
          title: "Cumplimiento 3PL",
          description:
            "Gestión logística integral, desde el almacenamiento hasta la entrega de pedidos, para brindarte tranquilidad.",
        },
        {
          title: "Preparación para Amazon FBA",
          description:
            "Preparamos tus productos para cumplir con las estrictas pautas de Amazon, permitiéndote empezar sin contratiempos.",
        },
        {
          title: "Mudanzas Locales",
          description:
            "Entregas y recolecciones locales confiables para mantener tus operaciones sin interrupciones.",
        },
      ],
      conclusion:
        "Nuestra ubicación estratégica en California, junto con un equipo experimentado, garantiza que tu logística esté siempre en buenas manos.",
    },
    //WhyEcomLogistics
    whyEcomLogistics: {
      title: "¿Por Qué Ecom Logistics?",
      intro:
        "En Ecom Logistics, no solo ofrecemos servicios logísticos — nos convertimos en tu socio estratégico para el crecimiento. Aquí tienes por qué elegirnos marca la diferencia:",
      features: [
        {
          title: "Ubicación Estratégica en California",
          description:
            "Nuestra cercanía con los principales puertos y proveedores garantiza tiempos de entrega más rápidos y una coordinación fluida, manteniendo tu inventario en movimiento.",
        },
        {
          title: "Experiencia en la Industria",
          description:
            "Con años de experiencia en comercio electrónico y logística, comprendemos los retos únicos que enfrentas. Sabemos cómo optimizar tu cadena de suministro para mayor eficiencia y ahorro.",
        },
        {
          title: "Servicio Confiable y Puntual",
          description:
            "Nos comprometemos con tiempos de respuesta rápidos y comunicación clara. Cuando necesitas que algo se haga, lo hacemos — a tiempo, siempre.",
        },
        {
          title: "Soluciones Personalizadas",
          description:
            "Cada negocio es diferente, por eso adaptamos nuestros servicios a tus necesidades específicas. Ya sea que manejes pocos envíos o una operación a gran escala, te respaldamos.",
        },
        {
          title: "Soporte Logístico de Principio a Fin",
          description:
            "Desde el almacenamiento hasta el envío, pasando por el cumplimiento y más, gestionamos todo el proceso logístico para que tú te enfoques en crecer.",
        },
        {
          title: "Atención Personalizada al Cliente",
          description:
            "Siempre estamos para ti, ofreciendo soporte receptivo y especializado cuando lo necesites. No eres solo un número — eres un socio valioso.",
        },
      ],
      conclusion1:
        "Cuando trabajas con Ecom Logistics, obtienes más que un proveedor logístico — obtienes un equipo dedicado al éxito de tu negocio.",
      conclusion2:
        "¿Listo para ver la diferencia? ¡Contáctanos hoy y deja que te mostremos cómo llevar tu logística al siguiente nivel!",
      button: "¡Contáctanos hoy!",
    },
    //SuccessSection
    successSection: {
      title: "Alcancemos el Éxito Juntos",
      paragraph1:
        "En Ecom Logistics creemos en el poder de la colaboración. No solo estamos aquí para gestionar tu logística — estamos para ayudarte a crecer, escalar y triunfar. Con nuestra experiencia y compromiso, trabajaremos contigo en cada paso para optimizar tus operaciones y alcanzar tus metas empresariales.",
      highlight: "¿Estás listo para liberar todo el potencial de tu negocio?",
      call: "Contáctanos ahora, y juntos construiremos una solución logística que impulse tu crecimiento y ofrezca resultados reales.",
    },
    //ContacUs
    contactAboutUs: {
      title: "Contáctanos",
      description:
        "¡Queremos saber de ti! Completa tu información de contacto a continuación. Cuando recibamos tu consulta, te contactaremos lo antes posible.",
      placeholders: {
        firstName: "Nombre",
        lastName: "Apellido",
        companyName: "Nombre de la empresa",
        ...
        phone: "Teléfono",
        serviceType: "Tipo de servicio",
        unitsPerMonth: "Número de unidades",
        shipmentsPerMonth: "Envíos por mes",
        message: "Información adicional...",
      },
      serviceOptions: {
        ltl: "LTL",
      ...
      success:
        "Información enviada correctamente. Nos pondremos en contacto en unos minutos.",
      error:
        "Ocurrió un error al enviar tu información. Intenta nuevamente más tarde.",
    },
  },
};
