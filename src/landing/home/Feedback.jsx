        ...
        <div className="mt-12 relative">
          ...
          <div className="mt-10 flex justify-end gap-4">
            <button
              ...
              className="w-10 h-10 flex items-center justify-center border border-blue rounded-full hover:bg-gray-300 disabled:opacity-30"
            >
            ...
            <button
              ...
              className="w-10 h-10 flex items-center justify-center bg-blue text-white rounded-full hover:bg-gray-300 disabled:opacity-30"
            >
